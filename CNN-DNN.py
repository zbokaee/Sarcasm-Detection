...
if __name__ == "__main__":
    ...
    train_file = basepath + '/resource/train/Train.txt'
    validation_file = basepath + '/resource/dev/Dev/valid.txt'
    test_file = basepath + '/resource/test/Test.txt'
    word_file_path = basepath + '/resource/wordlist.txt'
    split_word_path = basepath + '/resource/wordsplit.txt'
    emoji_file_path = basepath + '/resource/emoji.txt'

    output_file = basepath + '/resource/textmodel/TestResults.txt'
    model_file = basepath + '/resource/textmodel/weights/'
    vocab_file_path = basepath + '/resource/textmodel/vocab.txt'

    # word2vec path
    word2vec_path = '/home/win/word2vec/GoogleNews-vectors-negative300.bin'
    glove_path = '/home/spn/word2vec/glove_model_200.txt.bin'
